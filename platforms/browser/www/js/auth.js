$(document).ready(function(){
   ...
   //Add Bundle function
    ...
    var imageHash="http://www.gravatar.com/avatar/"+(localStorage.email);
...
$('#customer_name').load(hosturl+'customer.php', '', function(response, status, xhr) {
 
jQuery("#customer_name").selectmenu('refresh');

});
$('#building').load(hosturl+'building.php', '', function(response, status, xhr) {
 
jQuery("#building").selectmenu('refresh');

});
$('#loads').load(hosturl+'load.php', '', function(response, status, xhr) {
 
jQuery("#loads").selectmenu('refresh');

});
$('#warrant').load(hosturl+'warrant.php', '', function(response, status, xhr) {
 
jQuery("#warrant").selectmenu('refresh');

});
$('#location').load(hosturl+'location.php', '', function(response, status, xhr) {
 
jQuery("#location").selectmenu('refresh');

});
$('#brand').load(hosturl+'brand.php', '', function(response, status, xhr) {
 
jQuery("#brand").selectmenu('refresh');
